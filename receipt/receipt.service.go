...
func SetupRoutes(apiBasePath string) {
	...
	http.Handle(fmt.Sprintf("%s/%s", apiBasePath, receiptPath), cors.MiddlewareHndler(recieptHandler))
	http.Handle(fmt.Sprintf("%s/%s/", apiBasePath, receiptPath), cors.MiddlewareHndler(downloadHandler))
